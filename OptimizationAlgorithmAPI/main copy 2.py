...
def run_optimization(file_path: BytesIO, prosumersList) -> BytesIO:#, start_date_str, end_date_str) -> BytesIO:
#print("\n\n\ndates: "+start_date_str, end_date_str)
    ...
    update_interval=days/10;  #= 28800 # Update SOC every 288 time steps
