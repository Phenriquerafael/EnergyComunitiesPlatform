...
export default (app: Router) => {
    ...
    celebrate(
      {
        body: Joi.object({
          ...
          intervalOfTime: Joi.number().required(),
  ...
  route.post(
    ...
    celebrate({
      body: Joi.object({
        total_objective_value: Joi.number().optional(),
        ...
        detailed_results: Joi.array().items(
          Joi.object({
            ...
            P_buy: Joi.number().required(),
            P_sell: Joi.number().required(),
            SOC: Joi.number().required(),
            P_ESS_ch: Joi.number().required(),
            P_ESS_dch: Joi.number().required(),
            P_PV_load: Joi.number().required(),
            /* P_PV_ESS: Joi.string().required(), */
            P_Peer_out: Joi.number().required(),
            P_Peer_in: Joi.number().required(),
            P_Load: Joi.number().required(),
          }),
        ),
      }),
    }),
