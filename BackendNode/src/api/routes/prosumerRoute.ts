...
export default (app: Router) => {
  ...
  route.get('/id/:id', (req, res, next) => ctrl.getProsumer(req, res, next));

  route.get('/all', (req, res, next) => ctrl.findAll(req, res, next));

  route.get('/withoutCommunity', (req, res, next) => ctrl.findProsumersWithoutCommunity(req, res, next));
  ...
  route.get('/user/:id', (req, res, next) => ctrl.findByUserId(req, res, next));

  route.get('/battery/:id', (req, res, next) => ctrl.findByBatteryId(req, res, next));

  route.delete('/:id', (req, res, next) => ctrl.deleteProsumer(req, res, next));
