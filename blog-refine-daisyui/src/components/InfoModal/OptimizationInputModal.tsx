...
interface OptimizationInputModalProps {}

const OptimizationInputModal: FunctionComponent<
  OptimizationInputModalProps
> = () => {
  ...
  return (
    <>
      <h3 className="font-bold text-lg mb-4">
        Optimization algorithm input description
      </h3>
      ...
      <div className="mt-4">
        {activeTab === "PL" && (
          <div
            role="tabpanel"
            className="p-4 bg-base-100 border border-base-300 rounded-box overflow-x-auto"
          >
            ...
            <table className="table table-sm">
              <thead>
                <tr>
                  <th>DATE</th>
                  <th>TIME</th>
                  <th className="tooltip" data-tip="kWh">
                    PL1
                  </th>
                  <th>...</th>
                </tr>
        ...
        {activeTab === "ESS-Param" && (
          ...
          >
            <p className="mb-4 text-sm text-gray-600">
              Characteristics of the battery associated to prosumers
              individually.
            </p>
            <table className="table table-sm">
              <thead>
              ...
              <tbody>
                ...
                <tr>
                  <td
                    className="tooltip tooltip-right"
                    data-tip="Total battery capacity (kWh)"
                  >
                    Cap
                  </td>
                  <td>-</td>
...
export default OptimizationInputModal;
